#!/bin/bash
#SBATCH --job-name=Test_PDE_Legacy
#SBATCH --partition=defq
#SBATCH --output=logs/ABCD_%A_%a.out
#SBATCH --error=logs/ABCD_%A_%a.err
#SBATCH --array=1-132     
#SBATCH --ntasks=1
...
CHUNK_FILE="AADNA_data/frq_chunks/Master_Chunk_${TASK_ID}.rds"
SCRIPT_R_PATH="scripts/Emp_data/infLikelihood_mutations_binomial.R"
